...
public:
	...
	enum Anims //TDODO: Add grab possibility?
	{
		...
		L_PUNCH, M_PUNCH, H_PUNCH, F_L_PUNCH, F_M_PUNCH, F_H_PUNCH, L_KICK, M_KICK, H_KICK,
		...
		HIT, FACE_HIT, CROUCH_HIT, KNOCK_DOWN, KO, VICTORY, J_F_L_KICK, 
		J_F_M_KICK, J_F_H_KICK, J_F_L_PUNCH, J_F_M_PUNCH, J_F_H_PUNCH,
		LANDING
	};
